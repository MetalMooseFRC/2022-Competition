...
public class AutoFiveBallWall extends SequentialCommandGroup {
    ...
    addCommands(
      new ParallelRaceGroup(
        ...
        new SequentialCommandGroup(
          ...
          new WaitCommand(0.2),
          new AutonomousShootingAtSpeed(3100, m_shooter, m_gate, m_lifter, m_loader),
        //Shoot 2 balls

          new InstantCommand(() -> m_drivetrain.resetYaw(), m_drivetrain),
          new TurnToAngle(122, m_drivetrain),
          // new TurnToBall(() -> 0, m_drivetrain).withTimeout(0.4),
          ...
          new InstantCommand(() -> m_drivetrain.resetYaw(), m_drivetrain),
          new TurnToAngle(-3, m_drivetrain),
          ...
          new AutonomousShootingAtSpeed(3180.0, m_shooter, m_gate, m_lifter, m_loader),
        //Shoot 1 Ball
        
          new InstantCommand(() -> m_drivetrain.resetYaw(), m_drivetrain),
          new TurnToAngle(-17.5, m_drivetrain),
          new TurnToBall(() -> 0, m_drivetrain).withTimeout(0.5),
          new DriveStraight(m_drivetrain, 1.8, AUTO_DRIVE_SPEED),
