...
public class ShootingSequenceAtSpeed extends SequentialCommandGroup {
  ...
  public ShootingSequenceAtSpeed(Double speed, Shooter shooter, Gate gate, Lifter lifter, Loader loader) {
    m_shooter = shooter;
    m_lifter = lifter;
    m_loader = loader;
    m_gate = gate;
    ...
    addCommands(
      ...
      new InstantCommand(() -> m_shooter.setShooterSpeed(m_speed), m_shooter),
      new WaitUntilCommand(() -> ((m_shooter.getLeftWheelSpeed()) >= (m_speed*(0.90)))),
